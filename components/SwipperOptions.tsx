...
export default function SwipperOptions() {
    ...
    function swiperNext() {
        swiperRef.current.scrollLeft += 400
    }
    ...
    return (
        <div className={styles.swiperBox} >
            <div className={styles.swipperContainer} ref={swiperRef}>
            ...
            <button className={styles.btnPrev} onClick={swiperPrev}>
                <img src="/icons/chevron-down.svg" alt=""/>
            </button>
            <button className={styles.btnNext} onClick={swiperNext}>
                <img src="/icons/chevron-down.svg" alt=""/>
            </button>
        </div>
    )
